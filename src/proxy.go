...
// sourced from:https://github.com/LiamHaworth/go-tproxy
// with changes for only what we need here
import (
	"bytes"
	"encoding/binary"
	"fmt"
...
func ReadFromUDPConn(conn *net.UDPConn, b []byte) (int, *net.UDPAddr, *net.UDPAddr, error) {
	oob := make([]byte, 1024)
